...
class starter {
	...
	public static void searchArrInt(int value, ArrayList <Integer> array1){
		
		for(int i = 0; i < array1.size(); i++){
				if(value.equals(array1.get(i))){
					System.out.println(i);
			}
		}
	}
	
	public static void searchArrString(String value, ArrayList <String> array2){
		
		String answer;
		
		for(int i = 0; i < array2.size(); i++){
			if(value.equals(array2.get(i))){
				answer = "yes";
			}	
